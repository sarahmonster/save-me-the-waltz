( function( $ ) {
	...
	*/
	function adjustHero() {
		var savemethewaltzHeaderHeight = $( '#masthead' ).height();
		var savemethewaltzHeroContent = $( '#savemethewaltz-hero' ).find( '.savemethewaltz-panel-content' );
		$( savemethewaltzHeroContent ).css( 'padding-top', savemethewaltzHeaderHeight );
	}
	...
	*/
	function dynamicNav() {
		var $sections = $( '.savemethewaltz-panel' );
		...
		$sections.waypoint( {
			handler: function( direction ) {
				...
				if ( 'savemethewaltz-hero' === panelID ) {
